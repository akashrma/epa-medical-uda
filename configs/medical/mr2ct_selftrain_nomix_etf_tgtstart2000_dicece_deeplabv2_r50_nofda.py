...
uda = dict(
    ...
    etf_contrastive_target_start_iter=2000,
)
...
name = 'mr2ct_selftrain_nomix_etf_tgtstart2000_dicece_deeplabv2_r50_nofda'
exp = 'medical'
name_dataset = 'mr2ct'
name_architecture = 'deeplabv2_r50-d8'
name_encoder = 'r50'
name_decoder = 'dlv2'
name_uda = 'selftrain_nomix_etf_tgtstart2000_nofda'
