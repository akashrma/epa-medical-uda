...
# + per-pixel confidence weighting for mix loss
...
uda = dict(
    ...
    fda_L=0.1,
    fda_in_denorm=True,
    pseudo_weight_use_prob_dice=True,
)
...
name = 'mr2ct_selftrain_nomix_etf_tgt_dicece_segformer_mitb5_fda_ppw'
exp = 'medical'
name_dataset = 'mr2ct'
name_architecture = 'segformer_mitb5'
name_encoder = 'mitb5'
name_decoder = 'segformer'
name_uda = 'selftrain_nomix_etf_tgt_fda_ppw'
