...
# + source/target ETF contrastive loss (target starts at mix warmup)
...
uda = dict(
    mix='none',
    mix_start_iter=1000,
    etf_contrastive_lambda=0.5,
    etf_contrastive_temperature=0.05,
    etf_contrastive_target_lambda=0.5,
...
name = 'ct2mr_selftrain_nomix_etf_tgt_segformer_mitb5'
exp = 'medical'
name_dataset = 'ct2mr'
name_architecture = 'segformer_mitb5'
name_encoder = 'mitb5'
name_decoder = 'segformer'
name_uda = 'selftrain_nomix_etf_tgt'
