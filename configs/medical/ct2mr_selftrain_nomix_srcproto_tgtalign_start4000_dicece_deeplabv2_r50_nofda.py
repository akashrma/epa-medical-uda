...
uda = dict(
    ...
    dynamic_proto_target_start_iter=4000,
...
name = 'ct2mr_selftrain_nomix_srcproto_tgtalign_start4000_dicece_deeplabv2_r50_nofda'
exp = 'medical'
name_dataset = 'ct2mr'
name_architecture = 'deeplabv2_r50-d8'
name_encoder = 'r50'
name_decoder = 'dlv2'
name_uda = 'selftrain_nomix_srcproto_tgtalign_start4000_nofda'
