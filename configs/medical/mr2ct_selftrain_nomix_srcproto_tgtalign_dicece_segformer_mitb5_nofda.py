...
# + DiceCE segmentation loss + no FDA source->target style transfer
...
name = 'mr2ct_selftrain_nomix_srcproto_tgtalign_dicece_segformer_mitb5_nofda'
exp = 'medical'
name_dataset = 'mr2ct'
name_architecture = 'segformer_mitb5'
name_encoder = 'mitb5'
name_decoder = 'segformer'
name_uda = 'selftrain_nomix_srcproto_tgtalign_nofda'
